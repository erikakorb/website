...
text_time_water = data.groupby('Station').head(190).set_index('Station').tail(1)['Date'][0]  # 46
...
with colM2:
    ...
    view_state = pydeck.ViewState(
        latitude=45.33, longitude=12.37, controller=True, zoom=9.8, pitch=0,  height=3000,  width=500
    )
    chart = pydeck.Deck(
        point_layer,
